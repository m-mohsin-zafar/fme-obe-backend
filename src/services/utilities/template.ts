                        ...
                        <table class="table table-bordered tb-ovr">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  ${commulative.PLO10 ? passFail(commulative.PLO10["semester"]) : "-"}
                                </td>
                                <td>
                                  ${commulative.PLO11 ? passFail(commulative.PLO11["semester"]) : "-"}
                                </td>
                                <td>
                                  ${commulative.PLO12 ? passFail(commulative.PLO12["semester"]) : "-"}
                                </td>
                              </tr>
                            </tbody>
